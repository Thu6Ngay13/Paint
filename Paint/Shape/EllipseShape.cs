...
{
    public class EllipseShape : ObjectShape
    {
        ...
        public EllipseShape(Point start, Point end, object fill, Color outline, float sizeoutline)
        ...
        public override void Outline(Graphics graphic)
        {
            ...
            {
                graphic.DrawEllipse(pen, base.start.X, base.start.Y,
                    base.end.X - base.start.X, base.end.Y - base.start.Y);
            }
        }
        public override void Fill(Graphics graphic)
        {
            ...
            {
                graphic.FillEllipse(brush, base.start.X, base.start.Y,
                    base.end.X - base.start.X, base.end.Y - base.start.Y);
            }
        }
    }
