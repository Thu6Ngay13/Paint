...
namespace Paint.Shape
{
    public class RectangleShape : ObjectShape
    {
        ...
        public RectangleShape(Point start, Point end, object fill, Color outline, float sizeoutline)
        ...
        public override void Outline(Graphics graphic)
        {
            ...
            {
                graphic.DrawRectangle(pen, Math.Min(base.start.X, end.X), Math.Min(base.start.Y, end.Y),
        ...
        public override void Fill(Graphics graphic)
        {
            ...
            {
                graphic.FillRectangle(brush, Math.Min(base.start.X, end.X), Math.Min(base.start.Y, end.Y),
                    Math.Abs(base.end.X - base.start.X), Math.Abs(base.end.Y - base.start.Y));
            }
        }
    }
