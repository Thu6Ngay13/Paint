...
{
    public class ComplexShape : ObjectShape
    {
        public List<ObjectShape> Shapes;
        ...
        public ComplexShape(List<ObjectShape> shapes,
            Point start, Point end, object fill, Color outline, float sizeoutline)
            : base(start, end, fill, outline, sizeoutline)
        {
            ...
            {
                Shapes.Add(shape);
                if(shape.start.X < base.start.X)
                    base.start.X = shape.start.X;
                if (shape.start.Y < base.start.Y)
                    base.start.Y = shape.start.Y;
                if (shape.end.X > base.end.X)
                    base.end.X = shape.end.X;
                if (shape.end.Y > base.end.Y)
                    base.end.Y = shape.end.Y;
            }
        }
